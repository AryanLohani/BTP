...
import { createRandomData, addDataPoint } from './data-helpers4';
import './liveupdate.css'

class Liveupdatenewcompstat extends Component {
      ...
      <div className="pos">
        ...
        <HighchartsChart>
          ...
          <YAxis>
            ...
            <LineSeries name="Compressor Status" data={data1} />
          </YAxis>
        </HighchartsChart>
...
export default withHighcharts(Liveupdatenewcompstat, Highcharts);