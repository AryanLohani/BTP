...
import { createRandomData, addVoltageDataPoint } from './data-helpers2';
import './liveupdate.css'

class LiveupdatenewVoltage extends Component {
    ...
    return (
      <div className="pos">
        ...
        <HighchartsChart>
          ...
          <YAxis>
            <YAxis.Title>RPM </YAxis.Title>
            <LineSeries name="Humidity Sensor" data={data1} />
          </YAxis>
        </HighchartsChart>
...
export default withHighcharts(LiveupdatenewVoltage, Highcharts);