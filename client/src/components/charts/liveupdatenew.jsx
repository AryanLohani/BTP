...
class Liveupdatenew extends Component {
    ...
    return (
      <div className="pos">
        ...
        <HighchartsChart>
          ...
          <YAxis>
            <YAxis.Title>Current (A) </YAxis.Title>
            <LineSeries name="Current Sensor" data={data1} />
          </YAxis>
        </HighchartsChart>
...
export default withHighcharts(Liveupdatenew, Highcharts);